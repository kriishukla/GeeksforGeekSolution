<h2><a href="https://www.geeksforgeeks.org/problems/is-sudoku-valid4820/1?page=2&category=Matrix&company=Microsoft,Google&difficulty=Medium,Hard&sortBy=submissions">Is Sudoku Valid</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an&nbsp;incomplete Sudoku&nbsp;configuration in terms of a 9x9 &nbsp;2-D square matrix(<strong>mat[][]</strong>)&nbsp;the task to check if the current configuration is valid or not where a 0 represents an empty block.<br>
