<h2><a href="https://www.geeksforgeeks.org/problems/spiral-matrix--141631/1?page=2&category=Matrix&company=Microsoft,Google&difficulty=Medium,Hard&sortBy=submissions">Spiral Matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a matrix of size<strong> N x M</strong>. You have&nbsp;to find the <strong>K<sup>th</sup></strong> element which will&nbsp;obtain&nbsp;while traversing the matrix <strong>spirally</strong> starting from the top-left corner of the matrix.</span></p>
