<h2><a href="https://www.geeksforgeeks.org/problems/maximum-sub-array5443/1?page=3&category=Arrays,Sorting,Searching&company=Microsoft,Google&difficulty=Medium,Hard&sortBy=submissions">Maximum Sub Array</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Find out the maximum sub-array of non negative numbers from an array.</span></p>
